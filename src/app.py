...
activities = {
    ...
    "Drama Society": {
        "description": "Rehearse performances, learn acting skills, and put on school plays",
    ...
    "Debate Team": {
        "description": "Develop public speaking and persuasion skills through structured debates",
